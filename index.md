...
country: "uw"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
...
humandate: "January 13th - 16th, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Naomi Alterman", "Curtis Atkisson", "Bryna Hazelton", "Will Kumler"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Bernease Herman", "Hannah Mandell", "Gemma O'Connor", "Aji John", "June Yang"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2025-01-13-uw-online  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
pyeventbrite: 1109629384359          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
reventbrite:  1109647297939
...
<p> Participants only need to follow the setup instructions for the modules of
  the course they are enrolled in. If you are enrolled in the Python track, you
  should follow the instructions for "<b>The Bash Shell</b>", "<b>Git</b>",
  "<b>Text Editor</b>", and "<b>Python</b>". If you are enrolled in the R track,
  you should follow the instructions for "<b>The Bash Shell</b>", "<b>Git</b>",
